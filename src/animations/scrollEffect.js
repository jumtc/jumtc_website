...
export const capsuleScrollEffect = ({ capsuleTriggerRef, capsuleRef, innerScrollRef }) => {
	if (!capsuleTriggerRef?.current || !capsuleRef?.current || !innerScrollRef?.current) return;
